    ...
    <div class="container regis">
        ...
        <section class="regis-form">
            ...
            <ul>
                ...
                <li>เมื่อผู้เข้าแข่งขันเข้าไปทำโจทย์ตามที่ให้มาดังนี <a href="http://ctf.it.kmitl.ac.th">http://ctf.it.kmitl.ac.th</a> เมื่อถึงวันที่ 5 สิงหาคม 2559
                ...
                <li>กรอกรายละเอียดใน <a href="https://openhouse.it.kmitl.ac.th/2016/register/competition/network">openhouse.it.kmitl.ac.th/2016/register/competition/network</a> ให้ครบถ้วน จากนั้นให้ Print ใบสมัครแข่งขัน ลงลายมือชื่อรับรองจากอาจารย์ผู้ควบคุม</li>
