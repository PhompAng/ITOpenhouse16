...
<div class="logo">
    ...
    <h1><b>ผลการสมัครลงทะเบียนเข้าชมงานสำหรับนักเรียน/นักศึกษา</b></h1>
</div>
{{--{{dd($data['name'][0])}}--}}
<div class="section">
    <div class="col-md-8 col-md-offset-2">
        <div class="alert alert-success" role="alert">
            ลงทะเบียนสำเร็จ ระบบได้ส่งรหัสสำหรับเข้าร่วมงานไปที่หมายเลขโทรศัพท์ของท่าน โปรดนำมาติดต่อที่หน้างาน <br>
            ขอบคุณที่สนใจเข้าร่วมงานของเรา
        </div>
        <h2>ข้อมูลส่วนตัว</h2>
        <div class="row">
